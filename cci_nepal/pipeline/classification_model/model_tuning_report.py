...
def test_all_models(pipes, score, X_train, y_train_basic, y_train_non_basic):
    ...
    bs_lr_non_basic, bp_lr_non_basic = get_pipeline_results(
        search_lr, y_train_non_basic, X_train
    )
    bs_lr_basic, bp_lr_basic = get_pipeline_results(search_lr, y_train_basic, X_train)
    ...
    bs_knn_non_basic, bp_knn_non_basic = get_pipeline_results(
        search_knn, y_train_non_basic, X_train
    )
    bs_knn_basic, bp_knn_basic = get_pipeline_results(
    ...
    bs_rf_non_basic, bp_rf_non_basic = get_pipeline_results(
        search_rf, y_train_non_basic, X_train
    )
    bs_rf_basic, bp_rf_basic = get_pipeline_results(search_rf, y_train_basic, X_train)
    ...
    bs_dt_non_basic, bp_dt_non_basic = get_pipeline_results(
        search_dt, y_train_non_basic, X_train
    )
    bs_dt_basic, bp_dt_basic = get_pipeline_results(search_dt, y_train_basic, X_train)
    ...
    bs_nb_non_basic, bp_nb_non_basic = get_pipeline_results(
        search_nb, y_train_non_basic, X_train
    )
    bs_nb_basic, bp_nb_basic = get_pipeline_results(search_nb, y_train_basic, X_train)
    ...
    bs_svm_non_basic, bp_svm_non_basic = get_pipeline_results(
        search_svm, y_train_non_basic, X_train
    )
    bs_svm_basic, bp_svm_basic = get_pipeline_results(
        search_svm, y_train_basic, X_train
    )

    all_scores_basic = {
        "logistic": [bs_lr_basic, bp_lr_basic],
        "knn": [bs_knn_basic, bp_knn_basic],
        "rf": [bs_rf_basic, bp_rf_basic],
        "dt": [bs_dt_basic, bp_dt_basic],
        "nb": [bs_nb_basic, bp_nb_basic],
        "svm": [bs_svm_basic, bp_svm_basic],
    }

    all_scores_non_basic = {
        "logistic": [bs_lr_non_basic, bp_lr_non_basic],
        "knn": [bs_knn_non_basic, bp_knn_non_basic],
        "rf": [bs_rf_non_basic, bp_rf_non_basic],
        "dt": [bs_dt_non_basic, bp_dt_non_basic],
        "nb": [bs_nb_non_basic, bp_nb_non_basic],
        "svm": [bs_svm_non_basic, bp_svm_non_basic],
    }
