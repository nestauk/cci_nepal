...
# Project libraries
import cci_nepal
from cci_nepal.getters.free_text_analysis import get_complete_data as gcd
from cci_nepal.pipeline.free_text_analysis import term_manipulation as tm
...
df_combined = gcd.read_free_text_activity_data()
